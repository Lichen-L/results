...
beta_tt_private_bus= Beta('private bus travel time',0,-10,10,0)
...
beta_tt_motor=Beta('motor travel time',0,-10,10,0)
...
beta_area = Beta('beta for area',1,-10,10,1)
...
beta_threeplus_drive1=Beta('three plus cars in drive1',0,-10,30,0)
...
beta_threeplus_share3=Beta('three plus cars in share3 plus',0,-30,10,0)
