...
twoplus_tour_remain_Q=Beta('2+ tour remain dummy',0,-10,10,0)


work_tour_dummy_W=Beta('work tour dummy in work',0,-10,10,1)
edu_tour_dummy_W=Beta('edu tour dummy in work',0,-10,10,0)
shopping_tour_dummy_W=Beta('shopping tour dummy in work',0,-10,10,0)
other_tour_dummy_W=Beta('other tour dummy in work',0,-10,10,0)
female_dummy_W=Beta('female dummy in work',0,-10,10,0)
student_dummy_W=Beta('student dummy in work',0,-10,10,0)
worker_dummy_W=Beta('worker dummy in work',0,-10,10,0)
...
work_tour_dummy_E=Beta('work tour dummy in edu',0,-10,10,0)
edu_tour_dummy_E=Beta('edu tour dummy in edu',0,-10,10,1)
shopping_tour_dummy_E=Beta('shopping tour dummy in edu',0,-10,10,0)
other_tour_dummy_E=Beta('other tour dummy in edu',0,-10,10,0)
female_dummy_E=Beta('female dummy in edu',0,-10,10,0)
student_dummy_E=Beta('student dummy in edu',0,-10,10,0)
worker_dummy_E=Beta('worker dummy in edu',0,-10,10,0)
...
work_tour_dummy_S=Beta('work tour dummy in shopping',0,-10,10,0)
edu_tour_dummy_S=Beta('edu tour dummy in shopping',0,-10,10,0)
...
student_dummy_S=Beta('student dummy in shopping',0,-10,10,0)
...
work_logsum=Beta('work logsum in work',0,-10,10,0)
edu_logsum=Beta('edu logsum in edu',0,-10,10,0)
shop_logsum=Beta('shop logsum in shop',0,-10,10,0)
other_logsum=Beta('other logsum in other',0,-10,10,0)


time_window_work=Beta('time available in work',0,-10,10,0)
time_window_edu= Beta('time available in edu',0,-10,10,0)
time_window_shopping= Beta('time available in shopping',0,-10,10,0)
time_window_other= Beta('time available in other',0,-10,10,0)
...
MU2 = Beta('MU for non-quit', 2.0,0,100,1)
